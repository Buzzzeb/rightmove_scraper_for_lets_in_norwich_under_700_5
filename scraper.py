...
exchanges = {
    'Solihull':   ('B913AB','REGION%5E84007'),
}

for exc, pcode in exchanges.iteritems():
    url = '/property-for-sale/find.html?locationIdentifier=' + pcode[1] + '&maxPrice=150000&minBedrooms=2&radius=1.0'
